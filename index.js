...
function confirmStart() {
	...
	inquirer.prompt(readyToStartGame).then(answers => {
		...
		if (answers.readyToPlay){
			console.log(gameTextColor("Great! Welcome, " + answers.playerName + ". Let's play the Word Guess Game..."));
			startGame();
		}

		else {
			//If the user decides they don't want to play, exit game.
			console.log(gameTextColor("Good bye, " + answers.playerName + "! Play again soon."));
			return;
		}
	});
}
...
function checkIfUserWon() {
	...
	if (guessesRemaining === 0) {
		...
		console.log(gameTextColor("The correct coding term was: " + randomWord));
	...
	//else if the number of slots/underscores that are filled in with a letter equals the number of letters in the word, the user won.
		...
		console.log(gameTextColor("====================================================================="));
		console.log(correct("YOU WON! YOU'RE A TRUE CODER!"));
